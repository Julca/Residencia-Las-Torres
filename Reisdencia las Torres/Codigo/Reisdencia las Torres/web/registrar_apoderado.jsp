...
<jsp:useBean id="dnipersona" scope="request" class="java.lang.String" />
                        ...
                        <td>
                            <form method="POST" action="registroapoderado"> 
                                <select class="form-control col-xs-12" name="region" onchange="submit()">
                                    ...
                                    <input type="hidden" name="dnipersona2" value="<%=dnipersona%>">
                            </form>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <form method="POST" action="registroapoderado"> 
                                ...
                                <select class="form-control col-xs-12" name="provincia" onchange="submit()">
                                 ...
                                 <input type="hidden" name="dni2" value="<%=dni%>">
                                  <input type="hidden" name="dnipersona3" value="<%=dnipersona%>">
                            </form>
                        </td>
                    </tr>
                        ...
                        <td>
                            <form method="POST" action="registroapoderado"> 
                                ...
                                <input type="hidden" name="dni3" value="<%=dni%>">
                                 <input type="hidden" name="dnipersona4" value="<%=dnipersona%>">
                            </form>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="otros" >
                                ...
                                <input type="hidden" name="dnipersona5" value="<%=dnipersona%>"></td>
                        </tr>
                        <tr> 
                        ...
                        <tr>
                            <td colspan="5" align="center">
                                <input type="submit" class="btn btn-success" value="Guardar">    
                                 <input type="hidden" name="dnipersona1" value="<%=dnipersona%>">
                            </td>
                        </tr>
                    </tbody>
                </table>
