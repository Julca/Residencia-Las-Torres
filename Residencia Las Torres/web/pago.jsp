...
<%@include file="WEB-INF/jspf/top.jspf"%>
 <style type="text/css">
  ...
  background-color: #BEF781;
       ...
       <form class="form-horizontal" action="pago.jsp">
...
<table align="center" class="table table-striped" >
        ...
        <%
            String mensaje;
              ...
              String monto=request.getParameter("monto");monto=monto==null?"": monto;
              String cancelar=request.getParameter("cancelar");cancelar=cancelar==null?"": cancelar;
               String glosa=request.getParameter("glosa");glosa=glosa==null?"": glosa;
              ...
              String tipomovimiento=request.getParameter("tipomovimiento");tipomovimiento=tipomovimiento==null?"": tipomovimiento;
              int i=0;
